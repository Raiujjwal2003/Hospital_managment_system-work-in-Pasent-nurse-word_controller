<div class="row">
    ...
    <div class="col-sm-3">
        <a href="<?php echo site_url('admin/ward'); ?>">
            <div class="tile-stats tile-white tile-white-orange">
                <div class="icon"><i class="fa fa-user-md"></i></div>
                <div class="num" data-start="0" data-end="<?php echo $this->db->count_all('wardtype'); ?>"
                     data-duration="1500" data-delay="0"><?php echo $this->db->count_all('ward'); ?></div>
                <h3><?php echo get_phrase(' ward type') ?></h3>
            </div>
        </a>
    </div>
    ...
    <div class="col-sm-3">
        <a href="<?php echo site_url('admin/compounder'); ?>">
            <div class="tile-stats tile-white-purple">
                <div class="icon"><i class="fa fa-plus-square"></i></div>
                <div class="num" data-start="0" data-end="<?php echo $this->db->count_all('compounder'); ?>" 
                     data-duration="1500" data-delay="0"><?php echo $this->db->count_all('compounder'); ?></div>
                <h3><?php echo get_phrase('compounder') ?></h3>
            </div>
        </a>
    </div>
