<?php
$single_compounder_info = $this->db->get_where('compounder', array('compounder_id' => $param2))->result_array();
foreach ($single_compounder_info as $row) {
?>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo get_phrase('edit_compounder'); ?></h3>
                    </div>
                </div>

                <div class="panel-body">

                    <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('admin/compounder/update/'.row['compounder_id']); ?>" 
                            ...
                            <div class="col-sm-7">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
                                        <img src="<?php echo $this->crud_model->get_image_url('compounder' , $row['compounder_id']);?>" alt="...">
                                    </div>
