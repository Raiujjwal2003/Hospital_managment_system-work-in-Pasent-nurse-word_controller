        ...
        <div class="tab-content" style="padding-top: 15px;">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(site_url('index.php?admin/manage_language/add_phrase') , array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
            ...
            <div class="tab-pane box" id="add_lang" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(site_url('index.php?admin/manage_language/add_language'), array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
                            <div class="form-group">
