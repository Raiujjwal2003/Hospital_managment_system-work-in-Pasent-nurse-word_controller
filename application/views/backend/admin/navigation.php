<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'manage_wardtype' || $page_name == 'ward_facilities') echo 'active'; ?> ">
            <a href="<?php echo site_url('admin/wardtype');?>">
                <i class="fa fa-sitemap"></i>
                <span><?php echo get_phrase('wade type'); ?></span>
            </a>
        </li>


        <li class="<?php if ($page_name == 'manage_ward' || $page_name == 'ward_facilities') echo 'active'; ?> ">
            <a href="<?php echo site_url('admin/ward');?>">
                <i class="fa fa-sitemap"></i>
                <span><?php echo get_phrase('ward'); ?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'add_name') echo 'active'; ?> ">
            <a href="<?php echo site_url('admin/name');?>">
                <i class="fa fa-sitemap"></i>
        ...
        <li class="<?php if ($page_name == 'manage_compounder') echo 'active'; ?> ">
            <a href="<?php echo site_url('admin/compounder');?>">
                <i class="fa fa-user-md"></i>
                <span><?php echo get_phrase('compounder'); ?></span>
            </a>
        </li>
