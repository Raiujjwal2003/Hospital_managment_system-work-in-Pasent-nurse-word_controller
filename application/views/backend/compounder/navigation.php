...
<div class="sidebar-menu">
    ...
    <div class="sidebar-user-info">
        ...
        <div class="sui-hover inline-links animate-in"><!-- You can remove "inline-links" class to make links appear vertically, class "animate-in" will make A elements animateable when click on user profile -->				
            <a href="<?php echo site_url('compounder/manage_profile');?>">
    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'dashboard') echo 'active'; ?> ">
            <a href="<?php echo site_url('compounder');?>">
        ...
        <li class="<?php if ($page_name == 'manage_patient') echo 'active'; ?> ">
            <a href="<?php echo site_url('compounder/patient');?>">
        ...
        <li class="<?php if ($page_name == 'manage_report') echo 'active'; ?> ">
            <a href="<?php echo site_url('compounder/report');?>">
        ...
        <li class="<?php if ($page_name == 'payroll_list') echo 'active'; ?> ">
            <a href="<?php echo site_url('compounder/payroll_list');?>">
